...
# --- 1️⃣ RMSE Plot (Training vs Test) ---
p_rmse <- perf |>
...
# --- Additional Analysis ---
cat("\n## Key Insights:\n")
cat("• Linear Regression RMSE (Test):", round(lm_rmse_test, 0), "\n")
cat("• Random Forest (1 tree) RMSE (Test):", round(rf_1_rmse_test, 0), "- Improvement:", round((lm_rmse_test - rf_1_rmse_test)/lm_rmse_test * 100, 1), "%\n")
cat("• Random Forest (100 trees) RMSE (Test):", round(rf_100_rmse_test, 0), "- Improvement:", round((lm_rmse_test - rf_100_rmse_test)/lm_rmse_test * 100, 1), "%\n")
cat("• Random Forest (1000 trees) RMSE (Test):", round(rf_1000_rmse_test, 0), "- Improvement:", round((lm_rmse_test - rf_1000_rmse_test)/lm_rmse_test * 100, 1), "%\n")

cat("\n## Training vs Test Performance:\n")
cat("• Linear Regression - Train RMSE:", round(lm_rmse_train, 0), "| Test RMSE:", round(lm_rmse_test, 0), "| Train R²:", round(lm_r2_train, 3), "| Test R²:", round(lm_r2_test, 3), "\n")
cat("• Random Forest (1 tree) - Train RMSE:", round(rf_1_rmse_train, 0), "| Test RMSE:", round(rf_1_rmse_test, 0), "| Train R²:", round(rf_1_r2_train, 3), "| Test R²:", round(rf_1_r2_test, 3), "\n")
cat("• Random Forest (100 trees) - Train RMSE:", round(rf_100_rmse_train, 0), "| Test RMSE:", round(rf_100_rmse_test, 0), "| Train R²:", round(rf_100_r2_train, 3), "| Test R²:", round(rf_100_r2_test, 3), "\n")
cat("• Random Forest (1000 trees) - Train RMSE:", round(rf_1000_rmse_train, 0), "| Test RMSE:", round(rf_1000_rmse_test, 0), "| Train R²:", round(rf_1000_r2_train, 3), "| Test R²:", round(rf_1000_r2_test, 3), "\n")

cat("\n## Performance Analysis:\n")
cat("• Going from 1 tree to 100 trees improves RMSE by:", round((rf_1_rmse_test - rf_100_rmse_test)/rf_1_rmse_test * 100, 1), "%\n")
cat("• Going from 100 trees to 1000 trees improves RMSE by:", round((rf_100_rmse_test - rf_1000_rmse_test)/rf_100_rmse_test * 100, 1), "%\n")
cat("• Switching from Linear Regression to 100-tree Random Forest improves RMSE by:", round((lm_rmse_test - rf_100_rmse_test)/lm_rmse_test * 100, 1), "%\n")
```
